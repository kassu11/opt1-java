...
public class ExtraTest extends AbstractParent {
    ...
    public void testNeliojuuriNegat() {
        ArithmeticException poikkeus = assertThrows(ArithmeticException.class, () -> laskin.neliojuuri(-4));
        assertEquals("Negatiivisille numeroille ei ole neliöjuurta", poikkeus.getMessage());
    }
}
